...
//           }
//         })
//         particlesRef.current = realParticles
...
//       const angle = (Math.sin((p.x + time * 30) * 0.002) + Math.cos((p.y + time * 30) * 0.002)) * Math.PI
//       const speed = 0.5
...
//       const r = p.currentSize / 2
//       if (x <= r || x >= dimensions.width - r) x = Math.max(r, Math.min(dimensions.width - r, x))
//       if (y <= r || y >= dimensions.height - r) y = Math.max(r, Math.min(dimensions.height - r, y))
